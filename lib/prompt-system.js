...
STEP 1: 각 카드마다 교차 패턴 중 이 사람에게 가장 해당하는 4개를 골라,
패턴 이름을 명시하고 "이 패턴이 이 사람에게 왜 해당되는지"를 자기 말로 한 줄씩 쓰세요.
형식은 자유입니다. 단, 이 사람의 구체적인 사주/MBTI 데이터가 반드시 포함되어야 합니다.

STEP 2: 14개 카드 전체를 훑어보고, 같은 테마가 2개 이상의 카드에 등장하면
한 카드에만 남기고 나머지에서는 다른 패턴으로 교체하세요.

"_blueprint": {
  "나의 성격": [
    "패턴이름A: 이 사람에게 왜 해당되는지 한 줄",
    "패턴이름B: 이 사람에게 왜 해당되는지 한 줄",
    "패턴이름C: 이 사람에게 왜 해당되는지 한 줄",
    "패턴이름D: 이 사람에게 왜 해당되는지 한 줄"
  ],
  "나의 장점": ["...", "...", "...", "..."],
  "고쳐야 할 점": ["...", "...", "...", "..."],
  "남들이 보는 나": ["...", "...", "...", "..."],
