...
var SUPER_GROUP = {
  // ── 성격 / 스타일 ──
  '1_나의성격':       ['나의 성격'],
  '2_상대성격':       ['이 사람의 성격','감정 표현'],
  '3_연애스타일':     ['연애 스타일'],
  '4_우정스타일':     ['우정 스타일'],
  '5_업무스타일':     ['업무 스타일'],
  '6_외부인식':       ['남들이 보는 나','상대 눈에 비친 나'],
  // ── 니즈 / 갈등 ──
  '7_이상형니즈':     ['잘 맞는 타입','좋아하는 타입','바라는 것'],
  '8_업무선호':       ['선호 방식'],
  '9_싫어하는것':     ['연애 지뢰','싫어하는 타입','민감한 부분','싫어하는 방식','서운해하는 것'],
  // ── 소통 / 관계운영 ──
  '10_접근전략':      ['통하는 접근법'],
  '11_소통화해':      ['소통법','화해법','대화 팁','트러블 대처','회복법'],
  '12_직장인정':      ['인정받는 법'],
  // ── 시너지 / 장점 ──
  '13_끌림시너지':    ['끌림','잘 맞는 부분','시너지','같이 잘 되는 것','같이 성장'],
  '14_나의장점':      ['나의 장점'],
  '15_재물커리어':    ['맞춤 재물 쌓는 법','직장 적성'],
  // ── 개선 / 조율 ──
  '16_자기개선':      ['고쳐야 할 점'],
  '17_관계조율':      ['맞춰가야 할 부분','역효과 행동'],
  // ── 미래 / 타이밍 ──
  '18_연애진전':      ['사귀려면','어떤 커플'],
  '19_결혼':          ['결혼까지 가려면','결혼하면'],
  '20_타이밍운세':    ['기회의 시기','대운 흐름','올해 조언','올해 키워드'],
  // ── 마무리 ──
  '21_한줄요약':      ['인생 한줄 마무리','한 줄 요약']
};
...
var CAT_COMPAT = {
  premium:   ['premium','ssom','lover','colleague','friend'],
  ssom:      ['ssom','lover','friend','premium'],
  lover:     ['ssom','lover','friend','premium'],
  colleague: ['colleague','friend','premium'],
  friend:    ['ssom','lover','colleague','friend','premium']
};
